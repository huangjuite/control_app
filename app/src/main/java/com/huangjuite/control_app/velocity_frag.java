...
public class velocity_frag extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        tunerKp = new Tuner(kpUp, kpDown, seekBarKp, textKp, activity,24,35,0,"o");
        tunerKi = new Tuner(kiUp, kiDown, seekBarKi, textKi, activity,1.01,2,0.5,"u");
        tunerKd = new Tuner(kdUp, kdDown, seekBarKd, textKd, activity,32,50,0,"s");
        tunerReference = new Tuner(referenceUp, referenceDown, seekBarReference, textReference, activity,-0.9,2,-2,"e");
